...
<?php
 ...
 $id = $_GET['id'];
 $result = mysqli_query($conn, "SELECT * FROM producttable WHERE id = $id");
...
<div class="input-group mb-3">
 <input type="" name="quantity" class="form-control" id="name"
...
<label for="name">Product Detail</label>
 <div class="input-group mb-3">
 <input type="text" name="detail" class="form-control" id="name"
