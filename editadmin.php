...
<?php
 ...
 $id = $_GET['id'];
 $result = mysqli_query($conn, "SELECT * FROM admintable WHERE id = $id");
...
<label for="name">Gender</label>
 <div class="input-group mb-3">
 <input type="text" name="gender" class="form-control" id="name"
...
<div class="input-group mb-3">
 <input type="password" name="confirmedpass" class="form-control" id="name"
 value="<?php echo $row['confirmed_pass'] ?>">
</div>
