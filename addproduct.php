            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="text-center">New Product</h1>
                     <form action="newaddproduct.php" method="post">
<div class="input-group mb-3">
<input type="text" class="form-control" name="name" placeholder="Productname">
</div>
<div class="input-group mb-3">
<input type="text" class="form-control" name="price" placeholder="Productprice">
</div>
<div class="input-group mb-3">
<input type="text" class="form-control" name="detail" placeholder="Productdetail">
</div>
<div class="input-group mb-3">
<input type="text" class="form-control" name="quantity" placeholder="Productquantity">
</div>
<div class="input-group mb-3">
<input type="file" class="form-control" name="image" placeholder="Productimage">
</div>
<button type="submit" class="bg-primary">Add New Product</button>
</form>
