...
<h1 class="text-center">New Admin</h1>
                     <form action="newaddadmin.php" method="post">
...
<div class="input-group mb-3">
<input type="password" class="form-control" name="confirmedpass" placeholder="Confirmed Password">
</div>
<button type="submit" class="bg-primary">Add Admin</button>
</form>
